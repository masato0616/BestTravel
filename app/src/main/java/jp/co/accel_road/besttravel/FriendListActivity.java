...
public class FriendListActivity extends BaseActivity {
    ...
    /** 友達追加ボタン */
    private FloatingActionButton btnFriendAdd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 友達追加ボタン
        btnFriendAdd = (FloatingActionButton)findViewById(R.id.btnFriendAdd);
        btnFriendAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(intent, BestTravelConstant.ACTIVITY_REQUEST_KEY_FRIEND_SEARCH);
            }
        });
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            //友達検索画面からの戻り時処理
            case BestTravelConstant.ACTIVITY_REQUEST_KEY_FRIEND_SEARCH:
